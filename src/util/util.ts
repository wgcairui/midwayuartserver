...
export class Util {
  ...
  HexToSingle(t = Buffer.from([0, 0, 0, 0])): number {
    ...
    const t2 = <string>this.FillString(t1, '0', 32, true);
  ...
  SingleToHex(t = 0) {
    ...
    const e2 = <string>this.FillString(e1, '0', 8, true);
    const r = parseInt(s + e2 + m, 2).toString(16);
    const r1 = <string>this.FillString(r, '0', 8, true);
   ...
   */
  RegexLocation(location: string, reserver = false) {
