 ...
 */
@modelOptions({
  schemaOptions: { collection: 'log.smssends' },
 ...
 */
@modelOptions({
  schemaOptions: { collection: 'log.mailsends' },
  options: { allowMixed: 0 },
})
 ...
 */
@modelOptions({
  schemaOptions: { collection: 'log.userrequsts' },
  options: { allowMixed: 0 },
})
 ...
 */
@modelOptions({
  schemaOptions: { collection: 'log.terminals' },
  options: { allowMixed: 0 },
})
 ...
 */
@modelOptions({
  schemaOptions: { collection: 'log.instructquerys' },
  options: { allowMixed: 0 },
})
 ...
 */
@modelOptions({
  schemaOptions: { collection: 'log.wxevents' },
  options: { allowMixed: 0 },
})
 ...
 */
@modelOptions({
  schemaOptions: { collection: 'log.wxsubscribeMessages' },
  options: { allowMixed: 0 },
})
